...
`,b){let E=$u($,m("original")),f=$u(C,m("current")),g=y?{width:$.width,height:$.height}:void 0;l+=`  - Currently ${t2(E,{x:$.x,y:$.y},g)}
...
`)}if(t!=="compact"){let p=r.filter(y=>y.posMoved).map(y=>({label:y.section.label,originalRect:y.section.originalRect,currentRect:y.section.currentRect})),b=n2(p);if(b.length>0){l+=`
### Layout Summary
`;for(let y of b)l+=`- ${y}
...
`}}return l}var Ru="feedback-annotations-",Tp=7;function Pa(e){return`${Ru}${e}`}function yu(e){if(typeof window>"u")return[];try{let t=localStorage.getItem(Pa(e));if(!t)return[];let n=JSON.parse(t),o=Date.now()-Tp*24*60*60*1e3;return n.filter(r=>!r.timestamp||r.timestamp>o)}catch{return[]}}function Dp(e,t){if(!(typeof window>"u"))try{localStorage.setItem(Pa(e),JSON.stringify(t))}catch{}}function l2(){let e=new Map;if(typeof window>"u")return e;try{let t=Date.now()-Tp*24*60*60*1e3;for(let n=0;n<localStorage.length;n++){let o=localStorage.key(n);if(o?.startsWith(Ru)){let r=o.slice(Ru.length),l=localStorage.getItem(o);if(l){let s=JSON.parse(l).filter(a=>!a.timestamp||a.timestamp>t);s.length>0&&e.set(r,s)}}}}catch{}return e}function Ni(e,t,n){let o=t.map(r=>({...r,_syncedTo:n}));Dp(e,o)}var Du="agentation-design-";function i2(e){if(typeof window>"u")return[];try{let t=localStorage.getItem(`${Du}${e}`);return t?JSON.parse(t):[]}catch{return[]}}function s2(e,t){if(!(typeof window>"u"))try{localStorage.setItem(`${Du}${e}`,JSON.stringify(t))}catch{}}function a2(e){if(!(typeof window>"u"))try{localStorage.removeItem(`${Du}${e}`)}catch{}}var Bu="agentation-rearrange-";function c2(e){if(typeof window>"u")return null;try{let t=localStorage.getItem(`${Bu}${e}`);return t?JSON.parse(t):null}catch{return null}}function d2(e,t){if(!(typeof window>"u"))try{localStorage.setItem(`${Bu}${e}`,JSON.stringify(t))}catch{}}function u2(e){if(!(typeof window>"u"))try{localStorage.removeItem(`${Bu}${e}`)}catch{}}var zu="agentation-wireframe-";function _2(e){if(typeof window>"u")return null;try{let t=localStorage.getItem(`${zu}${e}`);return t?JSON.parse(t):null}catch{return null}}function cp(e,t){if(!(typeof window>"u"))try{localStorage.setItem(`${zu}${e}`,JSON.stringify(t))}catch{}}function Ea(e){if(!(typeof window>"u"))try{localStorage.removeItem(`${zu}${e}`)}catch{}}var Bp="agentation-session-";function Ou(e){return`${Bp}${e}`}function f2(e){if(typeof window>"u")return null;try{return localStorage.getItem(Ou(e))}catch{return null}}function xu(e,t){if(!(typeof window>"u"))try{localStorage.setItem(Ou(e),t)}catch{}}function h2(e){if(!(typeof window>"u"))try{localStorage.removeItem(Ou(e))}catch{}}var Pu=`${Bp}toolbar-hidden`;function p2(){if(typeof window>"u")return!1;try{return sessionStorage.getItem(Pu)==="1"}catch{return!1}}function m2(e){if(!(typeof window>"u"))try{e?sessionStorage.setItem(Pu,"1"):sessionStorage.removeItem(Pu)}catch{}}async function vu(e,t){let n=await fetch(`${e}/sessions`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:t})});if(!n.ok)throw new Error(`Failed to create session: ${n.status}`);return n.json()}async function dp(e,t){let n=await fetch(`${e}/sessions/${t}`);if(!n.ok)throw new Error(`Failed to get session: ${n.status}`);return n.json()}async function yl(e,t,n){let o=await fetch(`${e}/sessions/${t}/annotations`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(!o.ok)throw new Error(`Failed to sync annotation: ${o.status}`);return o.json()}async function up(e,t,n){let o=await fetch(`${e}/annotations/${t}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(!o.ok)throw new Error(`Failed to update annotation: ${o.status}`);return o.json()}async function or(e,t){let n=await fetch(`${e}/annotations/${t}`,{method:"DELETE"});if(!n.ok)throw new Error(`Failed to delete annotation: ${n.status}`)}var Je={FunctionComponent:0,ClassComponent:1,IndeterminateComponent:2,HostRoot:3,HostPortal:4,HostComponent:5,HostText:6,Fragment:7,Mode:8,ContextConsumer:9,ContextProvider:10,ForwardRef:11,Profiler:12,SuspenseComponent:13,MemoComponent:14,SimpleMemoComponent:15,LazyComponent:16,IncompleteClassComponent:17,DehydratedFragment:18,SuspenseListComponent:19,ScopeComponent:21,OffscreenComponent:22,LegacyHiddenComponent:23,CacheComponent:24,TracingMarkerComponent:25,HostHoistable:26,HostSingleton:27,IncompleteFunctionComponent:28,Throw:29,ViewTransitionComponent:30,ActivityComponent:31},_p=new Set(["Component","PureComponent","Fragment","Suspense","Profiler","StrictMode","Routes","Route","Outlet","Root","ErrorBoundaryHandler","HotReload","Hot"]),fp=[/Boundary$/,/BoundaryHandler$/,/Provider$/,/Consumer$/,/^(Inner|Outer)/,/Router$/,/^Client(Page|Segment|Root)/,/^Segment(ViewNode|Node)$/,/^LayoutSegment/,/^Server(Root|Component|Render)/,/^RSC/,/Context$/,/^Hot(Reload)?$/,/^(Dev|React)(Overlay|Tools|Root)/,/Overlay$/,/Handler$/,/^With[A-Z]/,/Wrapper$/,/^Root$/],g2=[/Page$/,/View$/,/Screen$/,/Section$/,/Card$/,/List$/,/Item$/,/Form$/,/Modal$/,/Dialog$/,/Button$/,/Nav$/,/Header$/,/Footer$/,/Layout$/,/Panel$/,/Tab$/,/Menu$/];function y2(e){let t=e?.mode??"filtered",n=_p;if(e?.skipExact){let o=e.skipExact instanceof Set?e.skipExact:new Set(e.skipExact);n=new Set([..._p,...o])}return{maxComponents:e?.maxComponents??6,maxDepth:e?.maxDepth??30,mode:t,skipExact:n,skipPatterns:e?.skipPatterns?[...fp,...e.skipPatterns]:fp,userPatterns:e?.userPatterns??g2,filter:e?.filter}}function x2(e){return e.replace(/([a-z])([A-Z])/g,"$1-$2").replace(/([A-Z])([A-Z][a-z])/g,"$1-$2").toLowerCase()}function v2(e,t=10){let n=new Set,o=e,r=0;for(;o&&r<t;)o.className&&typeof o.className=="string"&&o.className.split(/\s+/).forEach(l=>{if(l.length>1){let i=l.replace(/[_][a-zA-Z0-9]{5,}.*$/,"").toLowerCase();i.length>1&&n.add(i)}}),o=o.parentElement,r++;return n}function w2(e,t){let n=x2(e);for(let o of t){if(o===n)return!0;let r=n.split("-").filter(i=>i.length>2),l=o.split("-").filter(i=>i.length>2);for(let i of r)for(let s of l)if(i===s||i.includes(s)||s.includes(i))return!0}return!1}function b2(e,t,n,o){if(n.filter)return n.filter(e,t);switch(n.mode){case"all":return!0;case"filtered":return!(n.skipExact.has(e)||n.skipPatterns.some(r=>r.test(e)));case"smart":return n.skipExact.has(e)||n.skipPatterns.some(r=>r.test(e))?!1:!!(o&&w2(e,o)||n.userPatterns.some(r=>r.test(e)));default:return!0}}var xl=null,k2=new WeakMap;function wu(e){return Object.keys(e).some(t=>t.startsWith("__reactFiber$")||t.startsWith("__reactInternalInstance$")||t.startsWith("__reactProps$"))}function C2(){if(xl!==null)return xl;if(typeof document>"u")return!1;if(document.body&&wu(document.body))return xl=!0,!0;let e=["#root","#app","#__next","[data-reactroot]"];for(let t of e){let n=document.querySelector(t);if(n&&wu(n))return xl=!0,!0}if(document.body){for(let t of document.body.children)if(wu(t))return xl=!0,!0}return xl=!1,!1}var $i={map:k2};function S2(e){return Object.keys(e).find(n=>n.startsWith("__reactFiber$")||n.startsWith("__reactInternalInstance$"))||null}function M2(e){let t=S2(e);return t?e[t]:null}function Er(e){return e?e.displayName?e.displayName:e.name?e.name:null:null}function E2(e){let{tag:t,type:n,elementType:o}=e;if(t===Je.HostComponent||t===Je.HostText||t===Je.HostHoistable||t===Je.HostSingleton||t===Je.Fragment||t===Je.Mode||t===Je.Profiler||t===Je.DehydratedFragment||t===Je.HostRoot||t===Je.HostPortal||t===Je.ScopeComponent||t===Je.OffscreenComponent||t===Je.LegacyHiddenComponent||t===Je.CacheComponent||t===Je.TracingMarkerComponent||t===Je.Throw||t===Je.ViewTransitionComponent||t===Je.ActivityComponent)return null;if(t===Je.ForwardRef){let r=o;if(r?.render){let l=Er(r.render);if(l)return l}return r?.displayName?r.displayName:Er(n)}if(t===Je.MemoComponent||t===Je.SimpleMemoComponent){let r=o;if(r?.type){let l=Er(r.type);if(l)return l}return r?.displayName?r.displayName:Er(n)}if(t===Je.ContextProvider){let r=n;return r?._context?.displayName?`${r._context.displayName}.Provider`:null}if(t===Je.ContextConsumer){let r=n;return r?.displayName?`${r.displayName}.Consumer`:null}if(t===Je.LazyComponent){let r=o;return r?._status===1&&r._result?Er(r._result):null}return t===Je.SuspenseComponent||t===Je.SuspenseListComponent?null:t===Je.IncompleteClassComponent||t===Je.IncompleteFunctionComponent||t===Je.FunctionComponent||t===Je.ClassComponent||t===Je.IndeterminateComponent?Er(n):null}function L2(e){return e.length<=2||e.length<=3&&e===e.toLowerCase()}function I2(e,t){let n=y2(t),o=n.mode==="all";if(o){let a=$i.map.get(e);if(a!==void 0)return a}if(!C2()){let a={path:null,components:[]};return o&&$i.map.set(e,a),a}let r=n.mode==="smart"?v2(e):void 0,l=[];try{let a=M2(e),m=0;for(;a&&m<n.maxDepth&&l.length<n.maxComponents;){let p=E2(a);p&&!L2(p)&&b2(p,m,n,r)&&l.push(p),a=a.return,m++}}catch{let a={path:null,components:[]};return o&&$i.map.set(e,a),a}if(l.length===0){let a={path:null,components:[]};return o&&$i.map.set(e,a),a}let s={path:l.slice().reverse().map(a=>`<${a}>`).join(" "),components:l};return o&&$i.map.set(e,s),s}var Ri={FunctionComponent:0,ClassComponent:1,IndeterminateComponent:2,HostRoot:3,HostPortal:4,HostComponent:5,HostText:6,Fragment:7,Mode:8,ContextConsumer:9,ContextProvider:10,ForwardRef:11,Profiler:12,SuspenseComponent:13,MemoComponent:14,SimpleMemoComponent:15,LazyComponent:16};function N2(e){if(!e||typeof e!="object")return null;let t=Object.keys(e),n=t.find(l=>l.startsWith("__reactFiber$"));if(n)return e[n]||null;let o=t.find(l=>l.startsWith("__reactInternalInstance$"));if(o)return e[o]||null;let r=t.find(l=>{if(!l.startsWith("__react"))return!1;let i=e[l];return i&&typeof i=="object"&&"_debugSource"in i});return r&&e[r]||null}function Di(e){if(!e.type||typeof e.type=="string")return null;if(typeof e.type=="object"||typeof e.type=="function"){let t=e.type;if(t.displayName)return t.displayName;if(t.name)return t.name}return null}function $2(e,t=50){let n=e,o=0;for(;n&&o<t;){if(n._debugSource)return{source:n._debugSource,componentName:Di(n)};if(n._debugOwner?._debugSource)return{source:n._debugOwner._debugSource,componentName:Di(n._debugOwner)};n=n.return,o++}return null}function R2(e){let t=e,n=0,o=50;for(;t&&n<o;){let r=t,l=["_debugSource","__source","_source","debugSource"];for(let i of l){let s=r[i];if(s&&typeof s=="object"&&"fileName"in s)return{source:s,componentName:Di(t)}}if(t.memoizedProps){let i=t.memoizedProps;if(i.__source&&typeof i.__source=="object"){let s=i.__source;if(s.fileName&&s.lineNumber)return{source:{fileName:s.fileName,lineNumber:s.lineNumber,columnNumber:s.columnNumber},componentName:Di(t)}}}t=t.return,n++}return null}var La=new Map;function P2(e){let t=e.tag,n=e.type,o=e.elementType;if(typeof n=="string"||n==null||typeof n=="function"&&n.prototype?.isReactComponent)return null;if((t===Ri.FunctionComponent||t===Ri.IndeterminateComponent)&&typeof n=="function")return n;if(t===Ri.ForwardRef&&o){let r=o.render;if(typeof r=="function")return r}if((t===Ri.MemoComponent||t===Ri.SimpleMemoComponent)&&o){let r=o.type;if(typeof r=="function")return r}return typeof n=="function"?n:null}function T2(){let e=zp.default,t=e.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;if(t&&"H"in t)return{get:()=>t.H,set:o=>{t.H=o}};let n=e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;if(n){let o=n.ReactCurrentDispatcher;if(o&&"current"in o)return{get:()=>o.current,set:r=>{o.current=r}}}return null}function D2(e){let t=e.split(`
`),n=[/source-location/,/\/dist\/index\./,/node_modules\//,/react-dom/,/react\.development/,/react\.production/,/chunk-[A-Z0-9]+/i,/react-stack-bottom-frame/,/react-reconciler/,/scheduler/,/<anonymous>/],o=/^\s*at\s+(?:.*?\s+\()?(.+?):(\d+):(\d+)\)?$/,r=/^[^@]*@(.+?):(\d+):(\d+)$/;for(let l of t){let i=l.trim();if(!i||n.some(a=>a.test(i)))continue;let s=o.exec(i)||r.exec(i);if(s)return{fileName:s[1],line:parseInt(s[2],10),column:parseInt(s[3],10)}}return null}function B2(e){let t=e;return t=t.replace(/[?#].*$/,""),t=t.replace(/^turbopack:\/\/\/\[project\]\//,""),t=t.replace(/^webpack-internal:\/\/\/\.\//,""),t=t.replace(/^webpack-internal:\/\/\//,""),t=t.replace(/^webpack:\/\/\/\.\//,""),t=t.replace(/^webpack:\/\/\//,""),t=t.replace(/^turbopack:\/\/\//,""),t=t.replace(/^https?:\/\/[^/]+\//,""),t=t.replace(/^file:\/\/\//,"/"),t=t.replace(/^\([^)]+\)\/\.\//,""),t=t.replace(/^\.\//,""),t}function z2(e){let t=P2(e);if(!t)return null;if(La.has(t))return La.get(t);let n=T2();if(!n)return La.set(t,null),null;let o=n.get(),r=null;try{let l=new Proxy({},{get(){throw new Error("probe")}});n.set(l);try{t({})}catch(i){if(i instanceof Error&&i.message==="probe"&&i.stack){let s=D2(i.stack);s&&(r={fileName:B2(s.fileName),lineNumber:s.line,columnNumber:s.column,componentName:Di(e)||void 0})}}}finally{n.set(o)}return La.set(t,r),r}function O2(e,t=15){let n=e,o=0;for(;n&&o<t;){let r=z2(n);if(r)return r;n=n.return,o++}return null}function Tu(e){let t=N2(e);if(!t)return{found:!1,reason:"no-fiber",isReactApp:!1,isProduction:!1};let n=$2(t);if(n||(n=R2(t)),n?.source)return{found:!0,source:{fileName:n.source.fileName,lineNumber:n.source.lineNumber,columnNumber:n.source.columnNumber,componentName:n.componentName||void 0},isReactApp:!0,isProduction:!1};let o=O2(t);return o?{found:!0,source:o,isReactApp:!0,isProduction:!1}:{found:!1,reason:"no-debug-source",isReactApp:!0,isProduction:!1}}function A2(e,t="path"){let{fileName:n,lineNumber:o,columnNumber:r}=e,l=`${n}:${o}`;return r!==void 0&&(l+=`:${r}`),t==="vscode"?`vscode://file${n.startsWith("/")?"":"/"}${l}`:l}function W2(e,t=10){let n=e,o=0;for(;n&&o<t;){let r=Tu(n);if(r.found)return r;n=n.parentElement,o++}return Tu(e)}var F2=`.styles-module__toolbar___wNsdK svg[fill=none],
...
`)}),r.trim()}var H2=`@keyframes styles-module__markerIn___x4G8D {
  0% {
    opacity: 0;
...
.styles-module__switchContainer___Ka-AB:has(.styles-module__switchInput___kYDSD:checked) .styles-module__switchThumb___4sCPH {
  transform: translateX(8px);
}`,Q2={switchContainer:"styles-module__switchContainer___Ka-AB",switchInput:"styles-module__switchInput___kYDSD",switchThumb:"styles-module__switchThumb___4sCPH"};if(typeof document<"u"){let e=document.getElementById("feedback-tool-styles-switch-styles");e||(e=document.createElement("style"),e.id="feedback-tool-styles-switch-styles",document.head.appendChild(e)),e.textContent=X2}var bu=Q2,ku=({className:e="",...t})=>(0,Bi.jsxs)("div",{className:`${bu.switchContainer} ${e}`,children:[(0,Bi.jsx)("input",{className:bu.switchInput,type:"checkbox",...t}),(0,Bi.jsx)("div",{className:bu.switchThumb})]}),V2=`.styles-module__checkboxContainer___joqZk {
  display: flex;
  justify-content: center;
  align-items: center;
  position: relative;
...
.styles-module__checkboxContainer___joqZk:has(.styles-module__checkboxInput___ECzzO:checked) .styles-module__checkboxCheckPath___cDyh8 {
  ...
  stroke-dashoffset: 0;
}`,K2={checkboxContainer:"styles-module__checkboxContainer___joqZk",checkboxInput:"styles-module__checkboxInput___ECzzO",checkboxCheck:"styles-module__checkboxCheck___fUXpr",checkboxCheckPath:"styles-module__checkboxCheckPath___cDyh8"};if(typeof document<"u"){let e=document.getElementById("feedback-tool-styles-checkbox-styles");e||(e=document.createElement("style"),e.id="feedback-tool-styles-checkbox-styles",document.head.appendChild(e)),e.textContent=V2}var Ia=K2,q2=({className:e="",...t})=>(0,bl.jsxs)("div",{className:`${Ia.checkboxContainer} ${e}`,children:[(0,bl.jsx)("input",{className:Ia.checkboxInput,type:"checkbox",...t}),(0,bl.jsx)("svg",{className:Ia.checkboxCheck,width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",children:(0,bl.jsx)("path",{className:Ia.checkboxCheckPath,d:"M3.94 7L6.13 9.19L10.5 4.81",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})]}),G2=`.styles-module__container___w8eAF {
  display: flex;
  align-items: center;
  height: 24px;
}
...
[data-agentation-theme=dark] .styles-module__label___J5mxE {
  color: rgba(255, 255, 255, 0.5);
}`,Z2={container:"styles-module__container___w8eAF",label:"styles-module__label___J5mxE"};if(typeof document<"u"){let e=document.getElementById("feedback-tool-styles-checkbox-field-styles");e||(e=document.createElement("style"),e.id="feedback-tool-styles-checkbox-field-styles",document.head.appendChild(e)),e.textContent=G2}var gp=Z2,yp=({className:e="",label:t,tooltip:n,checked:o,onChange:r,...l})=>{let i=(0,Op.useId)();return(0,kl.jsxs)("div",{className:`${gp.container} ${e}`,...l,children:[(0,kl.jsx)(q2,{id:i,onChange:r,checked:o}),(0,kl.jsx)("label",{className:gp.label,htmlFor:i,children:t}),n&&(0,kl.jsx)(Nr,{content:n})]})},J2=`@keyframes styles-module__cycleTextIn___VBNTi {
  0% {
    opacity: 0;
    transform: translateY(-6px);
  }
